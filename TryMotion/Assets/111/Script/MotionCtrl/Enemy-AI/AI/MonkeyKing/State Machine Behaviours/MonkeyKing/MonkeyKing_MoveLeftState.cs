...
[CreateAssetMenu(fileName = "MonkeyKing_MoveLeftState" , menuName = "FSM/MonkeyKing/MonkeyKing_MoveLeftState" , order = -500)]
public class MonkeyKing_MoveLeftState : StateInfo_MonkeyKing
{
    [Header("移动速度")]
    ...
    public override void OnEnter(Animator animator , AnimatorStateInfo stateInfo , int layerIndex)
    {
        ...
        //随机2~4m移动距离.
        Vector3 movePos = -AiStateMachine.transform.right.normalized;
