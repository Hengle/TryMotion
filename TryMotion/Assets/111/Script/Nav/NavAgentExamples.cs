...
public class NavAgentExamples : MonoBehaviour
{
    ...
    [Header("当前路径状态")]
    public UnityEngine.AI.NavMeshPathStatus pathStatus;                //路径状态
    ...
    void Update()
    {
        ...
        if ((agent.remainingDistance <= agent.stoppingDistance && !pathPending) || pathStatus == UnityEngine.AI.NavMeshPathStatus.PathInvalid)
        {
