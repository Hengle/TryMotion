...
public class PlayerNav : MonoBehaviour
{
    ...
    public UnityEngine.AI.NavMeshPathStatus _status;           //路径状态
    ...
    void Update()
    {
        ...
        if (_agent.remainingDistance <= _agent.stoppingDistance || _agent.pathStatus == UnityEngine.AI.NavMeshPathStatus.PathInvalid)
        {
            SetNextDestintion();
        }
    }
